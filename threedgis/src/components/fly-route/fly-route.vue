      ...
      <div class="sm-half-L" v-show="routeType === 'designatedRoute'">
        ...
        <div class="sm-half-L" v-show="currentStopNames.length > 0">
          ...
          <select
            class="sm-select"
            style="width: 63%"
            v-model="selectedStopIndex"
          >
            <option
              :value="index"
              v-for="(stop, index) in currentStopNames"
              :key="index"
            >
              {{ stop }}
            </option>
      ...
      <div class="sm-half-L" v-show="routeType === 'customRoute'">
        ...
        <div class="sm-half-L" v-show="routeStops.length > 0">
          ...
          <select
            class="sm-select"
            style="width: 63%"
            v-model="selectedAddedStopIndex"
          >
            <option
              :value="index"
        ...
        <div class="boxchild">
          <button @click="addStop" class="tbtn" type="button">
            {{ Resource.add }}
          </button>
          <button
            @click="clearStop"
          ...
          <button @click="saveStop" class="tbtn tbtn-margin-left" type="button">
            {{ Resource.save }}
          </button>
        </div>
        ...
        <div class="sm-half-L" v-show="customRouteNames.length > 0">
          ...
          <div class="sm-half-L">
            ...
            <select
              class="sm-select"
              style="width: 63%"
              v-model="customRouteSelectedIndex"
            >
              <option
                :value="index"
          ...
          <div class="sm-half-L flex-around">
            ...
            <div class="boxchild" style="margin-bottom: -5px">
              <button @click="downLoad" class="tbtn" type="button">
                {{ Resource.downLoad }}
              </button>
              <button
                @click="clearRoute"
